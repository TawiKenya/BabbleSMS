...
public class TestnetworkcountDAO {
	...
	public void testallnetworks() {
		...
		networkcountDAO netcount= new networkcountDAO(DB_NAME, DB_HOST, DB_USERNAME, DB_PASSWD, DB_PORT);
	...
	public void testcollectcontacts(){
		...
		List<GroupContacts> count=netcount.collectContacts("a118c8ea-f831-4288-986d-35e22c91fc4d ");
