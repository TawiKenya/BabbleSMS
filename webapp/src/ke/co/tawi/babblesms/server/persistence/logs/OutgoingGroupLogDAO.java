...
public class OutgoingGroupLogDAO extends GenericDAO implements BabbleOutgoingGroupLogDAO {
    ...
    public boolean putOutgoingGrouplog(OutgoingGrouplog outgoinggroupLog) {
        ...
        try {
            ...
            pstmt = conn.prepareStatement("INSERT INTO OutgoinggroupLog (Uuid,origin,destination,message,sender,messagestatusuuid) VALUES (?,?,?,?,?,?);");

            pstmt.setString(1, outgoinggroupLog.getUuid());
            pstmt.setString(2, outgoinggroupLog.getOrigin());
            pstmt.setString(3, outgoinggroupLog.getDestination());
            pstmt.setString(4, outgoinggroupLog.getMessage());
            pstmt.setString(5, outgoinggroupLog.getSender());
            pstmt.setString(6, outgoinggroupLog.getMessagestatusuuid());
