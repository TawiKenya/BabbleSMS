...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-header well" data-original-title>
            ...
            <h2><i class="icon-edit"></i> add mask</h2>            
            <div class="box-icon">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="../addmask" method="POST">
                <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="maskname">Mask Name*</label>
                        <div class="controls">
                            <input class="input-xlarge focused" id="receiver" type="text" name="maskname" value="" required="true">
