...
<%@page
	import="ke.co.tawi.babblesms.server.accountmgmt.pagination.contact.ContactPaginator"%>
<%@page
	import="ke.co.tawi.babblesms.server.accountmgmt.pagination.contact.ContactPage"%>
...
<div class="col-lg-10 col-md-10 col-sm-5">	
	...
	<!--  		<a class="btn" href="#" onclick="del()" title="Export contacts" type="submit" data-rel="tooltip">Export</a>
			...
			<button class="btn btn-default dropdown-toggle dropdown" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="true"> more <span class="caret"></span></button>
-->
			...
			<div class="col-lg-5 col-md-5 col-sm-2">
				Search by Name:&nbsp;
				<input type="text" name="search" onkeyup="showuser(this.value)" placeholder="type then click enter to search" autofocus="autofocus">
			 </div>
			 ...
			 <div class="col-lg-4 col-md-4 col-sm-2">  
			    ...
			    <option class="grp" value="empty" name="All Contacts">All Contacts</option>
					...
					%>
					<option class="grp" value="<%=gr.getUuid()%>"
						name="<%=gr.getName()%>"><%=gr.getName()%></option>
					<%
						}
						} else {
					%>
...
<div style="margin-left: 30%; width: 50%;">
	<span id="prev" name="<%=account.getUuid()%>"> <span
		class="icon-fast-backward"></span> &nbsp;<a>Prev</a>&nbsp;&nbsp;&nbsp;
	</span> &nbsp;&nbsp;&nbsp; <span id="next"> <a>Next</a>&nbsp; <span
		class="icon-fast-forward"></span>
	</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
		id="first" value="First" type="submit"
		style="color: #fff; background-color: #555;">
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input id="last" value="Last"
		type="submit" style="color: #fff; background-color: #555;">
</div>
...
<div id="contactdiv" style="display: none;">
	<form class="form" action="editcontact" method="POST" id="contact">
		...
		<p
			style="margin-top: 1px; margin-right: 2px; position: absolute; top: 1%; right: 1%; color: red; font-size: 20px;"
			id="close">x</p>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input class="input-xlarge focused" id="paragraph_1" type="text"
					name="name" required>
			</div>
		</div>
		...
		<div class="control-group" id="phone">
			...
			<div class="controls" id="addphones1">
				<input class="input-xlarge focused" id="phone2" name="phone1[]"
					type="text" onkeypress='return validateQty(event);' required>
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea rows="2" cols="9" style="width: 50%;" class="textarea"
					id="textarea" name="description"></textarea>
			</div>
		</div>
		...
		<div class="table-save">
			...
			<input type="hidden" id="uuid" name="uuid" class="edit_area" /> <input
				type="hidden" name="statusuuid" value="<%=Status.ACTIVE%>" /> <br />
			<br />
