            ...
            <div class="container-fluid">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-2">
                                ...
                                <div class="logo ">
                                    <img alt="Tawi Commercials" title="Tawi Commercial" src="img/tawi-logo-with-slogan.png" />
                                    <br /> 
                                    <a href="#"><h1>Babble SMS</h1></a>
                                </div>
                ...
                <!-- the google API ReCaptcha to prevent bots from logging in -->
                  ...
                  <button type="submit" class="btn btn-default">Submit</button>
                    ...
                    <p>
                        <a href="account/resetPassword.jsp" target="_top"> Forgot Password</a>
                    </p>
             ...
             <!-- the left section with the banner image -->
                ...
                <div class="col-lg-9 col-md-9 col-sm-4 banner" style="min-height: 800px;">
                        <h3> <a href="#">Babble SMS</a></h3>

                        <h1>Your Convenient SMS Messenger</h1>

                        <p>Allows you to send SMS from the convenience of your web browser.</p>
