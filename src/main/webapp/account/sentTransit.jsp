...
<%@page
	import="ke.co.tawi.babblesms.server.accountmgmt.pagination.sent.SentPaginator"%>
...
<%
	...
	if (incount == 0) { // This user has no Incoming USSD in the account
		...
		if (sentPage == null || !StringUtils.endsWith(referrer, "sentTransit.jsp")
...
<div class="col-lg-10 col-md-10 col-sm-5">
	...
	<div id="refresh" class="col-lg-1 col-md-1 col-sm-1">
		<form name="pageForm" method="post" action="sentTransit.jsp">
			<p>
				<input class="btn btn-info" type="submit" name="refresh"
					value="Refresh" /> <input class="btn btn-info" type="hidden"
	...
	<div id="pagination" class="col-lg-5 col-md-5 col-sm-2">
		<form name="pageForm" method="post" action="sentTransit.jsp">
			...
			<span class="pageInfo">Page <span
				class="pagePosition currentPage"><%=sentPage.getPageNum()%></span>
				of <span class="pagePosition"><%=sentPage.getTotalPage()%></span>
			</span>
			<%
	...
	<div id="export" class="col-lg-2 col-md-2 col-sm-1">
		...
		<form id="exportToExcel" name="exportExcelForm" method="post"
			action="exportExcelOutbox" target="_blank">
			<p>
				<input class="btn btn-info" type="hidden" name="exportExcel"
					value="Export All"> <input class="btn btn-info"
					type="submit" name="exporttoxEcel" value="Export Page As Excel">
				<input class="btn btn-info" type="hidden" name="page"
					value="sentTransit.jsp">
			</p>
		</form>
	</div>
	<div id="export" class="col-lg-2 col-md-2 col-sm-1">
		<form id="exportToExcel" name="exportExcelForm" method="post"
			...
			<p>
				<input class="btn btn-info" type="hidden" name="exportExcel"
					value="Export Page"> <input class="btn btn-info"
					type="submit" name="exporttoExcel" value="Export All As Excel">
				<input class="btn btn-info" type="hidden" name="page"
					value="sentTransit.jsp">
			</p>
		</form>
	...
	<div class="col-lg-12 col-md-12 col-sm-6">
		...
		<div class="col-lg-3 col-md-3 col-sm-3">
			<div class="btn-group">
				<button type="button" class="btn btn-default">Sent and in Transit</button>
				...
				<%
					if (outgoingList != null) {
						...
						for (OutgoingLog log : outgoingList) {
							if (messageHash.get(log.getMessagestatusuuid()).equals("Transit")) {
				%>
				<tr width="5%">
					...
					<td class="center"><%=dateFormatter.format(log.getLogTime())%>
					</td>
