...
<div id="ContactsAdd col-lg-9 col-md-9 col-sm-4 table-responsive">
	...
	<div id="showtext">
		<table class="table table-striped table-bordered bootstrap-datatable datatable "
			...
			<tr>
				...
				<td class="center"><a class="Zlink" href="#"
					title="click to edit details"><%=contact.getName()%></a></td>
							...
							if (phoneList != null) {
								...
								for (Phone ph : phoneList) {
									out.println(ph.getPhonenumber() + " ("
											+ StringUtils.split(networkHash.get(ph.getNetworkuuid()))[0] + ")<br/>");
								}
								out.println("</td>");
		...
		<span style="text-align: center;">Page <span class="pgNum"
			style="color: #317EAC; font-weight: bold;"
			name="<%=contactPage.getPageNum()%>"> <%=contactPage.getPageNum()%></span>
			of <span class="pgSize" style="color: #317EAC; font-weight: bold;"
			name="<%=contactPage.getTotalPage()%>"> <%=contactPage.getTotalPage()%></span>
			Page(s)
		</span>
	</div>
</div>
