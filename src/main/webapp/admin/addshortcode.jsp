...
<div class="row-fluid sortable">
    <div class="box span12">
        <%             String addErrStr = (String) session.getAttribute(SessionConstants.ADMIN_ADD_SMSSHORTCODE_ERROR_KEY);
            ...
            HashMap<String, String> paramHash = (HashMap<String, String>) session.getAttribute(
                    SessionConstants.ADMIN_ADD_SMSSHORTCODE_PARAMETERS);
        ...
        <div class="box-header well" data-original-title>
            ...
            <h2><i class="icon-edit"></i> add shortcode</h2>            
            <div class="box-icon">
        ...
        <div class="box-content">
            <form class="form-horizontal" action="../addshortcode" method="POST">
                <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="network">Code Number*</label>
                        <div class="controls">
                            <input class="input-xlarge focused" id="receiver" type="text" name="shortcode" value="" required="true">
